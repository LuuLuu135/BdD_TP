...
INSERT INTO SESION VALUES ('2023-02-28', '15:45:00', '2023-02-28', '20:15:00', 'n0temueras'),
					   ...
					   ('2023-11-12', '07:20', '2023-11-12', '10:11', 'HypnosRequiem'),
					   ...
					   ('2023-11-12', '15:20', '2023-11-12', '18:12', 'HypnosRequiem'),
...
SELECT mo.Nombre_Modalidad, AVG(DATEDIFF(minute, '00:00', p.Duracion)) AS DuracionPromedio
FROM PARTIDA p
JOIN MODALIDAD mo ON p.ID_Modalidad = mo.ID_Modalidad
GROUP BY mo.Nombre_Modalidad ;
