...
INSERT INTO SESION VALUES(28/2/2023, 15:45, 28/2/2023, 20:15, "n0temueras"), --nuevamente problema para ingresar la hora
						(12/3/2023, 08:15, 12/3/2023, 10:30, "Nikino"),
						(6/5/2023, 13:00, 6/5/2023, 18:45, "XopiuX"),
...
INSERT INTO HABILIDADES VALUES ('Soul Shards',2,30,1),
							...
							('Blood Awe',3,39,4),
							('Alpha, Charge!',4,20,5,20588235294118),
							('Force Swing',3,50,4,97058823529412),
							('Beta, Advance',1,10,4,5),
							('Rotary Impact',2,30,4,73529411764706),
							('Whirling Smash',3,42,5,91176470588235),
							('Pursuit',1,0,6),
							('Fission Wave',4,70,6,14705882352941),
							('Groundsplitter',2,37,5,6764705882353),
							('Puppet-on-a-String',3,68,6,85294117647059),
							('Smart Heart',1,0,7),
							('Heartguard',4,0,7,08823529411765),
							('Love Waves',2,32,6,61764705882353),
							('Eternal Evil',4,30,8,02941176470588),
							('Warmonger',1,15,8),
							('Demonic Grip',2,32,7,55882352941177),
							('Meteoric Sword',3,40,7,79411764705882),
							('Vengeance',3,36,8,73529411764706),
							('Demon Gaze',1,0,9),
							('Dauntless Strike',2,40,8,5),
							('Final Slash',4,80,9),
							('Fatal Links',4,76,9,91176470588235),
							('Frigid Breath',1,0,10),
							('Perfect Match',3,42,9,6764705882353),
							('Annihilate',2,39,10),
							...
							('Supreme Warrior',4,0,119); --The number of columns for each row in a table value constructor must be the same.
